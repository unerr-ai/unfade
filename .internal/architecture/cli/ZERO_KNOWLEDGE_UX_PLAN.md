...
- `docs/architecture/cli/PHASE_0_SCAFFOLDING.md` — Update command hierarchy, add `unfade mcp` hidden command
- `docs/architecture/cli/PHASE_1_CAPTURE_AND_DISTILL.md` — Redesign init flow (skip LLM prompt, add immediate first distill, add self-healing state detector)
- `docs/architecture/cli/PHASE_2_HOOKS_API_AND_MCP.md` — Add `unfade mcp` hidden command, add "Connect AI Tools" web UI section
- `docs/architecture/cli/PHASE_5_ECOSYSTEM_LAUNCH.md` — Expand UF-086 scope, change README quickstart from `npx unfade init` to `npx unfade`
- `docs/architecture/daily_plan.md` — Update Day 1 to reflect zero-knowledge init flow
